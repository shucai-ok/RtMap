...
public class BluetoothDialogFragment extends DialogFragment {
    ...
    public static final String BLUETOOTH_DIALOG_TAG = "bluetooth_dialog_tag";
    public static final String BLUETOOTH_DIALOG_DATA = "bluetooth_dialog_data";
    ...
    public static final BluetoothDialogFragment newInstance() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        dialogImg.setImageResource(R.drawable.bg_bluetooth);
